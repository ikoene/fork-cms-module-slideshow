...
class Edit extends BackendBaseActionEdit
{
    ...
    private function loadForm()
    {
        ...
        $this->frm->addCheckbox('mousewheel_navigation', ($this->settings['mousewheel_navigation'] === 'true' ? true : false));
    ...
    private function loadDataGrid()
    {
        ...
        // set column order
        $this->dataGrid->setColumnsSequence('dragAndDropHandle','checkbox','preview','image_hidden','title','description','edit');
    ...
    private function validateForm()
    {
        ...
        if($this->frm->isSubmitted())
        {
            ...
            if($this->frm->isCorrect())
            {
                ...
                $settings['animation_type'] = $this->frm->getField('animation_type')->getValue();
                $settings['slide_direction'] = $this->frm->getField('slide_direction')->getValue();
                $settings['slideshow_speed'] = $this->frm->getField('slideshow_speed')->getValue();
                $settings['animation_duration'] = $this->frm->getField('animation_duration')->getValue();
                $settings['direct_navigation'] = $this->frm->getField('direct_navigation')->getChecked() ? 'true' : 'false';
                $settings['control_navigation'] = $this->frm->getField('control_navigation')->getChecked() ? 'true' : 'false';
                $settings['keyboard_navigation'] = $this->frm->getField('keyboard_navigation')->getChecked() ? 'true' : 'false';
                $settings['mousewheel_navigation'] = $this->frm->getField('mousewheel_navigation')->getChecked() ? 'true' : 'false';
                $settings['random_order'] = $this->frm->getField('random_order')->getChecked() ? 'true' : 'false';
